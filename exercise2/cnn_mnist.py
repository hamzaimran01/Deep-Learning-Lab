...
from cnntf import Cnn_Tensorflow 
...
def main(unused_argv):
  ...
  mnist_classifier = tf.estimator.Estimator(model_fn=Cnn_Tensorflow.model, model_dir="./models")
  tensors_to_log = {"probabilities": "softmax_tensor"}
  logging_hook = tf.train.LoggingTensorHook(
      tensors=tensors_to_log, every_n_iter=50)

  # Training the data as given in the tensofrflow website
  train_input_fn = tf.estimator.inputs.numpy_input_fn(
      x={"x": train_data},
      y=train_labels,
      batch_size=128,
      num_epochs=12,
      shuffle=False)#to aoid overfitting
