...
def FCN_Seg(self, is_training=True):
    ...
    if self.configuration == 1:
        ...
        if (current_up5.shape[1] != self.tgt_image.shape[1]):
            ...
            End_maps_decoder1 = slim.conv2d(current_up5, self.N_classes, [1, 1], scope='xyz') #(batchsize, width, height, N_classes)
    ...
    if self.configuration == 2:
        ...
        print("I'm in configuration 2")
        print("current_up3")#38*38*120
        current_up3=TransitionUp_elu(x,120,2,"2_transition")
       
        print(DB4_skip_connection)#38*38*96
        
        
        if (current_up3.shape[1]!= DB4_skip_connection.shape[1]):
            print("im in the if1 loop")
            ...
            current_up3=Convolution(current_up3, 256, 3, "2_1_conv")
            print("current_up3")
            print(current_up3)
            print("I WANT TO KNOW THIS")
            current_up3=TransitionUp_elu(x,120,8,"2_fs")
            print(current_up3)
            ...
            current_up3=TransitionUp_elu(current_up3,120,8,"2_final")
            print("current_up3")
            print(current_up3)
    ...
    if self.configuration == 3:
        ...
        print("I'm in configuration 3")
        print("current_up4_a")#38*38*120
        current_up4_a=TransitionUp_elu(x,120,2,"3_2times")
        ...
        if (current_up4_a.shape[1]!= DB4_skip_connection.shape[1]):
            ...
            current_up4_a=Concat_layers(current_up4_a,DB4_skip_connection, nm='test3_a_concat')#38*38*192
            current_up4_a=Convolution(current_up4_a, 256, 3, "3_a_concat")
            
        else:
            print("im in the else1 loop")
            current_up4_a=Concat_layers(current_up4_a,DB4_skip_connection, nm='test3_a_concat')#38*38*192
            current_up4_a=Convolution(current_up4_a, 256, 3, "3_a_concat")
       ...
       # current_up4_b=TransitionUp_elu(current_up4_a,120,2,"3_2times")
        ...
        print(DB3_skip_connection)#75*75*32
        print("current_up4_b")
        current_up4_b=TransitionUp_elu(current_up4_a,160,2,"3_4times")#76*76*160
        
        
        if (current_up4_b.shape[1]!= DB3_skip_connection.shape[1]):
            print("im in the if2 loop")
            current_up4_b=crop(current_up4_b,DB3_skip_connection)
            print("concatenated shape is")
            current_up4_b=Concat_layers(current_up4_b,DB3_skip_connection, nm='test3_a_concat')#75*75*192
            ...
            print("im in the else2 loop")
            current_up4_b=Concat_layers(current_up4_a,DB4_skip_connection, nm='test3_a_concat')#38*38*192
    ...
    if self.configuration == 4:
        ...
        # but that also fuse the upsampled features with the corresponding skip connection (DB4_skip_connection)
        # through concatenation. After that use a convolution with kernel 3x3 to produce 256 output feature maps
        print("I'm in configuration 4")
        print("current_up5_a")#38*38*120
        ...
        if (current_up5_a.shape[1]!= DB4_skip_connection.shape[1]):
            ...
            current_up5_a=Concat_layers(current_up5_a,DB4_skip_connection, nm='test3_a_concat')#38*38*192
        ...
        print(DB3_skip_connection)#75*75*32
        print("current_up4_b")
        current_up5_b=TransitionUp_elu(current_up5_a,160,2,"4_2_1times")#76*76*160
        ...
        if (current_up5_b.shape[1]!= DB3_skip_connection.shape[1]):
            ...
            print("concatenated shape is")
            current_up5_b=Concat_layers(current_up5_b,DB3_skip_connection, nm='test4_a_concat')#75*75*192
            print(current_up5_b)
            ...
            print("im in the else2 loop")
            current_up5_b=Concat_layers(current_up5_b,DB3_skip_connection, nm='test4_a_concat')#38*38*192
        ...
        print(DB2_skip_connection)#150*150*24
        print("current_up4_b")
        current_up5_c=TransitionUp_elu(current_up5_b,96,2,"4_2_2times")#150*150*96
        ...
        if (current_up5_c.shape[1]!= DB2_skip_connection.shape[1]):
            ...
            print("concatenated shape is")
            current_up5_c=Concat_layers(current_up5_c,DB2_skip_connection, nm='test4_c_concat')#75*75*192
            ...
            print("im in the else2 loop")
            current_up5_c=Concat_layers(current_up5_c,DB2_skip_connection, nm='test4_c_concat')#38*38*192
